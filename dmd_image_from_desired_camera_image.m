function dmd_image = dmd_image_from_desired_camera_image(camera_image, tube_magnification, camera_image_offset, camera_image_binning)
...
%     dmd_image_check = ...
%         map_camera_image_into_dmd_space_without_offset_or_scaling(camera_image, ...
%                                                                   debarrel_parameter, ...
%                                                                   transform_to_dmd_space_from_debarreled_camera_space, ...
%                                                                   dmd_reference_frame) ;
end
