function I2 = correct_lens_distortion(I, k, varargin)
%CORRECT_LENS_DISTORTION corrects for barrel and pincusion lens abberations
%   I = CORRECT_LENS_DISTORTION(I, k) corrects for radially symmetric
%   distortions, where I is the input image and k is the distortion
%   parameter. lens distortion can be one of two types: barrel distortion
%   and pincushion distortion. In "barrel distortion", image magnification
%   decreases with distance from the optical axis. The apparent effect is
%   that of an image which has been mapped around a sphere (or barrel). In
%   "pincushion distortion", image magnification increases with the
...
%   the centre of the image, like a pincushion [1].
%  
%   I = CORRECT_LENS_DISTORTION(...,PARAM1,VAL1,PARAM2,VAL2,...) creates a
%   new image image, specifying parameters and corresponding values that
%   control various aspects of the image distortion correction. Parameter
%   names case does not matter.
%
%   Parameters include:
%
